...
alias vgpp='g++ -std=c++26 -Wall -Wextra -Wpedantic -Wconversion -fmodules-ts -fsanitize=address,leak,undefined'
...
alias tk='cat ~/valetoriy/TOKEN.txt | wl-copy'
alias gs='git status'
alias gl='git log'
alias gd='git diff'
alias ga='git add'
...
alias get_idf='. /home/spff/Downloads/esp/esp-idf/export.sh'
