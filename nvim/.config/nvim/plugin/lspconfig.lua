...
local sumneko_root_path = '/home/spff/gitimport/lua-language-server'
local sumneko_binary = sumneko_root_path.."/bin/lua-language-server"
--local sumneko_binary = '~/gitimport/lua-language-server/bin/Linux/lua-language-server'
...
--     root_dir = {'/home/spff/gitimport/glsl-language-server'}
-- }
